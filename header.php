    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="produk.php" class="nav-link">Perumahan</a></li>
          <li class="nav-item active"><a href="suratizinperusahaan.php" class="nav-link">Surat Izin Perusahaan</a></li>
          <?php
          include 'koneksi.php';
